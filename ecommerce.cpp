...
void F_General_Menu()
{
    ...
    for (int i = 0; i < 1000; i++)
    {
        ...
        case 50:
        { // Register ('sign up')   // Set details with validation
            for (int i = 0; i != 1;)
            {
                system("cls");
                cout << "____________________________________________________________________________________________________ \n";
                ...
                if (Validation == 3)
                {
                    ...
                    i++;
                    cout << "                          Please press any keyboard to continue program" << endl
                         << endl;
                    system("Pause");
                    Validation = 0;
                }
                else
                {
                    ...
                    cout << "                          Please press any keyboard to rewrite details" << endl
                         << endl;
                    system("Pause");
                    system("cls");
                    Validation = 0;
...
void F_Developers()
{
    ...
    cout << "____________________________________________________________________________________________________\n\n";
    cout << "\n\t\t\t\t'AliBazar' Online Shopping Aplication " << endl
         << endl;
...
void F_Vegetables_Fruits_Menu()
{
    for (int k = 0; k < 1000; k++)
    {
        ...
        cout << Test.get_quantity_potatoes() << " (kg)" << endl;
        ...
        cout << " 3. Onion, Weight \t\t\t\t\t";
        cout << Test.get_quantity_onion() << " (kg)" << endl;
...
void F_Water_Beverages_Menu()
{
    for (int k = 0; k < 1000; k++)
    {
        ...
        cout << Test1.get_quantity_water_hydrolife_750ml() << " (pc)" << endl;
        cout << "    " << Test1.get_price_water_hydrolife_750ml() << " UZS for 1 pc\n\n";
        cout << " 2. Drink, Aloe Original 500ml \t\t\t\t";
        cout << Test1.get_quantity_drink_aloe_500ml() << " (pc)" << endl;
        cout << "    " << Test1.get_price_drink_aloe_500ml() << " UZS for 1 pc\n\n";
        cout << " 3. Nectar, Zet Apple 125ml \t\t\t\t";
        cout << Test1.get_quantity_nectar_zet_125ml() << " (pc)" << endl;
        ...
        case 49:
        {
            for (int j = 0; j < 1000; j++)
            {
                ...
                {
                case 49:
                    if (Test1.get_storage_quantity_water_hydrolife_750ml() > 0)
                    { // checking for storage and user needs
        ...
        case 50:
        {
            for (int j = 0; j < 1000; j++)
            {
                ...
                {
                case 49:
                    if (Test1.get_storage_quantity_drink_aloe_500ml() > 0)
                    { // checking for storage and user needs
        ...
        case 51:
        {
            for (int j = 0; j < 1000; j++)
            {
                ...
                case 49:
                    //
                    if (Test1.get_storage_quantity_nectar_zet_125ml() > 0)
                    { // checking for storage and user needs
...
void F_Bread_Bakery_Menu()
{
    for (int k = 0; k < 1000; k++)
    {
        ...
        cout << "____________________________________________________________________________________________________\n\n";
        cout << " 1. Bun Smart Food \t\t\t\t\t";
        cout << Test2.get_quantity_bun_smart_food() << " (pc)" << endl;
        cout << "    " << Test2.get_price_bun_smart_food() << " UZS for 1 pc\n\n";
        cout << " 2. Cracker Tuc cheese 100g \t\t\t\t";
        cout << Test2.get_quantity_cracker_tuc_cheese_100g() << " (pc)" << endl;
        cout << "    " << Test2.get_price_cracker_tuc_cheese_100g() << " UZS for 1 pc\n\n";
        cout << " 3. Bread Of SAMARKAND \t\t\t\t\t";
        cout << Test2.get_quantity_bread_samarkand() << " (pc)" << endl;
        ...
        case 50:
        {
            for (int j = 0; j < 1000; j++)
            {
                ...
                case 49:
                    ...
                    if (Test2.get_storage_quantity_cracker_tuc_cheese_100g() > 0)
                    { // checking for storage and user needs
...
void F_Cart_Check()
{
    ...
    for (int i = 1; i <= 1; i++)
    {
        ...
        {
            cout << "\n\t  " << i << "."
                 << "Potatoes, Weight    " << Test.get_quantity_potatoes() << " (kg)     Price: " << Test.get_quantity_potatoes() * Test.get_price_potatoes();
            i++;
        ...
        {
            cout << "\n\t  " << i << "."
                 << "Carrot, Weight      " << Test.get_quantity_carrot() << " (kg)     Price: " << Test.get_quantity_carrot() * Test.get_price_carrot();
            i++;
        ...
        {
            cout << "\n\t  " << i << "."
                 << "Onion, Weight       " << Test.get_quantity_onion() << " (kg)     Price: " << Test.get_quantity_onion() * Test.get_price_onion();
            i++;
        ...
        {
            cout << "\n\t  " << i << "."
                 << "Aloe 500ml          " << Test1.get_quantity_drink_aloe_500ml() << " (pc)     Price: " << Test1.get_quantity_drink_aloe_500ml() * Test1.get_price_drink_aloe_500ml();
            i++;
        ...
        {
            cout << "\n\t  " << i << "."
                 << "Nectar Zet 125ml    " << Test1.get_quantity_nectar_zet_125ml() << " (pc)     Price: " << Test1.get_quantity_nectar_zet_125ml() * Test1.get_price_nectar_zet_125ml();
            i++;
        ...
        {
            cout << "\n\t  " << i << "."
                 << "Hydrolife 750ml     " << Test1.get_quantity_water_hydrolife_750ml() << " (pc)     Price: " << Test1.get_quantity_water_hydrolife_750ml() * Test1.get_price_water_hydrolife_750ml();
            i++;
        ...
        {
            cout << "\n\t  " << i << "."
                 << "Samarkand Bread ,   " << Test2.get_quantity_bread_samarkand() << " (pc)     Price: " << Test2.get_quantity_bread_samarkand() * Test2.get_price_bread_samarkand();
            i++;
        ...
        {
            cout << "\n\t  " << i << "."
                 << "Bun Smart Food ,    " << Test2.get_quantity_bun_smart_food() << " (pc)     Price: " << Test2.get_quantity_bun_smart_food() * Test2.get_price_bun_smart_food();
            i++;
        ...
        {
            cout << "\n\t  " << i << "."
                 << "Tuc Cheese 100g ,   " << Test2.get_quantity_cracker_tuc_cheese_100g() << " (pc)     Price: " << Test2.get_quantity_cracker_tuc_cheese_100g() * Test2.get_price_cracker_tuc_cheese_100g();
            i++;
